      ...
      <div style="width: 600px;">
        ...
        <div class="relative bg-white rounded-md border-foreground">
          ...
          <div class="absolute max-2xl:hidden text-[#888888] right-[-160px] top-10">
            <h3 class="-mb-6 -mr-6 text-right" style="font-family: 'Comic Sans MS', cursive, sans-serif;">Your signature</h3>
            <svg xmlns="http://www.w3.org/2000/svg" width="180.96" height="194.92" stroke-linecap="round" stroke-linejoin="round" style="background-color:transparent" viewBox="934.22 340.96 180.96 194.92"><g opacity=".5" transform="translate(1086.51 328.43)"><defs><mask id="a"><path fill="#fff" d="M-220.291-55.472h316.96v330.92h-316.96z"/><path fill="none" d="m-114.41 176.63-5.881-1.18 3.965-4.51"/></mask></defs><g mask="url(#a)"><path fill="transparent" d="M-100-100h316.96v330.92H-100z"/><path fill="none" stroke="currentColor" stroke-dasharray="4.09 4.27" stroke-dashoffset="2" stroke-width="2" d="M-3.323 44.528a172.504 172.5 0 0 1-116.968 130.924"/></g><path fill="none" stroke="currentColor" stroke-width="2" d="m-114.41 176.63-5.881-1.18 3.965-4.51"/></g></svg>
          </div>
      </div>
    </div>
  </div>
